...
import com.android.launcher3.clover.CloverUtils;
    ...
    public static class LauncherSettingsFragment extends PreferenceFragmentCompat implements
        ...
        protected boolean initPreference(Preference preference) {
            ...
            switch (preference.getKey()) {
                ...
                case KEY_MINUS_ONE:
                    return CloverUtils.isPackageEnabled(getActivity(), SEARCH_PACKAGE);
                case KEY_SUGGESTIONS:
                    return CloverUtils.isPackageEnabled(getActivity(), SUGGESTIONS_PACKAGE);
            }
            return true;
        }
