...
import com.android.launcher3.CloverQuickstepLauncher;
import com.android.launcher3.CloverLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        CloverQuickstepLauncher launcher = (CloverQuickstepLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        CloverLauncherModelDelegate delegate = (CloverLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        CloverQuickstepLauncher launcher = (CloverQuickstepLauncher) ActivityContext.lookupContext(getContext());
